...
def main(opts, args):
    ...
    assert stime < etime, ("Start time must be less than end time... "
                           "otherwise why are you using this?")
...
if __name__ == '__main__':
    ...
    parser.add_option('-C', '--cache_dir', dest='cache_dir',
                      help=("directory in which to put the downloaded file in "
    ...
    parser.add_option('-T', '--threshold', dest='thresh',
                      help=("Distance threshold to use when matching stations."
