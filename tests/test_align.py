...
@pytest.mark.parametrize(('obs_tuple', 'expected_hid', 'expected_time',
    ...
    (Row(time=datetime(2012, 9, 26, 18),
         val=123,
         ...
         station_id='1047172',
         lat=None,
         lon=None), 21, datetime(2012, 9, 26, 18), 2, 123),
    ...
    (Row(time=datetime(2012, 9, 26, 18),
         ...
         station_id='1047172',
         lat=49.45,
         lon=-123.7), 20, datetime(2012, 9, 26, 18), 2, 100),
    ...
    (Row(time=datetime(2012, 9, 26, 18),
         ...
         station_id='11091',
         lat=None,
         lon=None), 1, datetime(2012, 9, 26, 18), 1, 10),
    ...
    (Row(time=datetime(2012, 9, 26, 18),
         ...
         station_id='666',
         lat=49,
         lon=-121), 5, datetime(2012, 9, 26, 18), 1, 10),
    ...
    (Row(time=datetime(2012, 9, 26, 18),
         ...
         station_id='1047172',
         lat=51,
         lon=-128), 5, datetime(2012, 9, 26, 18), 2, 123)
])
